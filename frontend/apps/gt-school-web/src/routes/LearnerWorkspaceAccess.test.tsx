...
vi.mock("../features/learner/LearnerWorkspace", () => ({
  default: () => <div data-testid="LearnerWorkspace">LearnerWorkspace</div>,
}));
...
function openWorkspace() {
  return render(
    <MemoryRouter initialEntries={["/learner/workspace"]}>
      <AppRoutes />
    </MemoryRouter>
  );
}

describe("Learner Workspace route access", () => {
  it("allows an authenticated user into the Learner workspace", async () => {
    openWorkspace();
