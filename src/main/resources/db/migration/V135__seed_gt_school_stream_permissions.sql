-- Seed GT School stream permissions
...
CROSS JOIN (
    ...
    (
        ...
        'Create Stream',
        'SCHOOL_ACADEMIC',
        'Allows creation of class streams or sections'
    ),
    (
        'school.academic.stream.read',
        'Read Streams',
        'SCHOOL_ACADEMIC',
        'Allows viewing class streams or sections'
    ),
    (
        'school.academic.stream.manage',
        'Manage Streams',
        'SCHOOL_ACADEMIC',
        'Allows lifecycle management of class streams or sections'
    )
) AS p(
    code,
    name,
