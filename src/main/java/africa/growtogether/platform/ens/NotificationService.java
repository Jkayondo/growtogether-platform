...
public class NotificationService {
    ...
    private final EnsConfigurationGateway config;
    ...
    public NotificationService(
            ...
            EnsConfigurationGateway config,
    ...
    @Transactional
    public View markProcessing(UUID id) {
    ...
    @Transactional
    public View markDelivered(UUID id) {
    ...
    private NotificationRequest entity(UUID id) {

        return repo.findByIdAndTenantId(
                id,
                identity.tenantId()
        )
        .orElseThrow(
