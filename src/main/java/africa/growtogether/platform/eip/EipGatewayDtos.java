...
public final class EipGatewayDtos {private EipGatewayDtos(){}
 ...
 public record ConnectorCommand(@NotBlank String connectorCode,@NotBlank String connectorType,@NotBlank String baseUrl,@NotBlank String authType,String credential,String providerConfiguration){
  public ConnectorCommand(String connectorCode,String connectorType,String baseUrl,String authType,String credential){
   this(connectorCode,connectorType,baseUrl,authType,credential,null);
  }
 }
 public record CredentialRotationCommand(@NotBlank String credential){}
 ...
 public record ConnectorView(UUID id,String connectorCode,String connectorType,String baseUrl,String authType,String providerConfiguration,boolean active){
  static ConnectorView from(ExternalConnector c){
   return new ConnectorView(c.id(),c.connectorCode(),c.connectorType(),c.baseUrl(),c.authType(),c.providerConfiguration(),c.active());
  }
 }
}
