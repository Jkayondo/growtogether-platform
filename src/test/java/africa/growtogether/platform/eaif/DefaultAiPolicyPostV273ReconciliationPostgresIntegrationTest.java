...
@SpringBootTest
class DefaultAiPolicyPostV274ReconciliationPostgresIntegrationTest {

    private static final String MIGRATION =
            "db/migration/"
                    + "V274__reconcile_post_v273_default_ai_policy.sql";
    ...
    static final PostgreSQLContainer<?> postgres =
            new PostgreSQLContainer<>(
                    ...
                    .withDatabaseName(
                            "growtogether_v274_policy_reconciliation_test"
                    )
    ...
    void reconciliationRepairsOnlyMissingPolicyAndIsIdempotent()
        ...
        Integer repairedByV274 =
                jdbc.queryForObject(
                        ...
                        WHERE tenant_id = ?
                          AND policy_code = 'DEFAULT_AI_POLICY'
                          AND created_by = 'GT-MIGRATION-V274'
                        """,
                        Integer.class,
                        tenantId
                );

        assertThat(repairedByV274)
                .isEqualTo(1);
